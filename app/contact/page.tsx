        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                <div className="w-10 h-10 bg-blue-400/20 rounded-lg flex items-center justify-center mr-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300">123 Medical Center Drive<br />Healthcare City, MED 12345</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-300">contact@nextmed.com</p>
                </div>
              </div>
          ...
          <div className="dark-glass-card p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full dark-glass-button text-white font-medium py-2 px-4 rounded-md transition-colors"
              >
                Send Message
              </button>
            </form>
